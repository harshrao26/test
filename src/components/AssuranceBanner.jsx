...
const AssuranceBanner = () => {
  return (
    <div className="bg-gradient-to-r my-20 max-w-7xl relative mx-auto from-yellow-100 to-white rounded-2xl shadow-md p-6 md:p-10 flex flex-col md:flex-row items-center gap-6">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center justify-end gap-4 text-gray-700 text-b">
          <div className="flex items-start gap-2">
            <CheckCircle size={18} className="text-yellow-500 mt-1" />
