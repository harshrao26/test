...
export default function HeroSection() {
      ...
      <div className="flex flex-col items-center justify-center w-full h-full pt-20">
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between  gap-4">
          ...
          <div className="bg-white/90 p-6 rounded-xl md:w-1/2 py-">
            ...
            <h1 className="text-4xl md:text-4xl font-medium capitalize border-l-4 border-[#16C47F] pl-6 mb-4 leading-tight">
              All Legal{" "}
              <span
              ...
              >
                <span className="bg-[#16C47F] text-white px-3 rounded-full">
  ...
  <div className="relative flex-1 text-gray-600 focus-within:text-gray-900">
    ...
    <input
      ...
      className="w-full pl-10 pr-12 py-2 rounded-full border border-[#16C47F] focus:outline-none focus:ring-2 focus:ring-[#16C47F]"
    />
    {query && (
      <X
        size={18}
